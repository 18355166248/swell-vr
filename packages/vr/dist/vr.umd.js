(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.Vr = {}));
  ...
  class TipManager extends EventEmitter {
    ...
    create(config) {
      ...
      sprite.scale.set((scale == null ? void 0 : scale.x) ?? 3, (scale == null ? void 0 : scale.y) ?? 3, (scale == null ? void 0 : scale.z) ?? 3);
  ...
  function update3dObjectBaseInfo(object, baseInfo) {
    ...
    if (position && !new Vector3(position.x, position.y, position.z).equals(
      object.position
    )) {
  ...
  function addListenerToThree(getDeps, events = [
    "click",
    "mousemove",
    "touchmove",
    "mouseup"
  ...
  exports2.VREventNames = VREventNames;
