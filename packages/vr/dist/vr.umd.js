;(function (global, factory) {
    ...
    raycast(raycaster2, intersects) {
      ...
      if (_sphere$5.containsPoint(_ray$3.origin) === false) {
        ...
        if (
          ...
          (raycaster2.far - raycaster2.near) ** 2
        )
          return
      }
    ...
    function render(renderList, scene) {
      ...
      if (
        ...
        boxMesh.material.toneMapped =
          background.colorSpace === SRGBColorSpace ? false : true
        if (
  ...
  class Sprite extends Object3D {
    ...
    raycast(raycaster2, intersects) {
      ...
      this.modelViewMatrix.multiplyMatrices(
        raycaster2.camera.matrixWorldInverse,
        this.matrixWorld,
      )
      _mvPosition.setFromMatrixPosition(this.modelViewMatrix)
      if (
        raycaster2.camera.isPerspectiveCamera &&
      ...
      _uvB.set(1, 0)
      _uvC.set(1, 1)
      let intersect = raycaster2.ray.intersectTriangle(
        _vA,
        _vB,
        _vC,
        false,
      ...
      if (intersect === null) {
        ...
        _uvB.set(0, 1)
        intersect = raycaster2.ray.intersectTriangle(
          _vA,
          _vC,
          _vB,
          false,
  ...
  class Raycaster {
    ...
    setFromCamera(coords, camera) {
      if (camera.isPerspectiveCamera) {
        ...
        console.error(
          'THREE.Raycaster: Unsupported camera type: ' + camera.type,
        )
      }
    }
  ...
  class TipManager {
    ...
    create(config) {
      ...
      sprite.scale.set(
        (scale == null ? void 0 : scale.x) ?? 3,
        (scale == null ? void 0 : scale.y) ?? 3,
        (scale == null ? void 0 : scale.z) ?? 3,
      )
  ...
  function getRaycasterAndMouse() {
    ...
    if (!mouseVector) mouseVector = new Vector2()
    return {
      raycaster,
      mouse: mouseVector,
    }
  ...
  function formatBaseInfo(baseInfo) {
    ...
    return {
      position: {
        x:
          ((_a = baseInfo == null ? void 0 : baseInfo.position) == null
            ? void 0
            : _a.x) ?? 0,
        y:
          ((_b = baseInfo == null ? void 0 : baseInfo.position) == null
            ? void 0
            : _b.y) ?? 0,
        z:
          ((_c = baseInfo == null ? void 0 : baseInfo.position) == null
            ? void 0
            : _c.z) ?? 0,
      },
      rotate: {
        x:
          ((_d = baseInfo == null ? void 0 : baseInfo.rotate) == null
            ? void 0
            : _d.x) ?? 0,
        y:
          ((_e = baseInfo == null ? void 0 : baseInfo.rotate) == null
            ? void 0
            : _e.y) ?? 0,
        z:
          ((_f = baseInfo == null ? void 0 : baseInfo.rotate) == null
            ? void 0
            : _f.z) ?? 0,
      },
      scale: {
        x:
          ((_g = baseInfo == null ? void 0 : baseInfo.scale) == null
            ? void 0
            : _g.x) ?? 1,
        y:
          ((_h = baseInfo == null ? void 0 : baseInfo.scale) == null
            ? void 0
            : _h.y) ?? 1,
        z:
          ((_i = baseInfo == null ? void 0 : baseInfo.scale) == null
            ? void 0
            : _i.z) ?? 1,
      },
    }
  ...
  function update3dObjectBaseInfo(object, baseInfo) {
    ...
    if (
      position &&
      !new Vector3(position.x, position.y, position.z).equals(object.position)
    ) {
    ...
    if (
      rotate &&
      !new Euler(rotate.x, rotate.y, rotate.z).equals(object.rotation)
    ) {
      object.rotation.set(rotate.x, rotate.y, rotate.z)
    }
  }
  function addListenerToThree(
    getDeps,
    events = ['click', 'mousemove', 'touchmove', 'mouseup'],
  ) {
    ...
    function handleEvent(eventName, event) {
      ...
      if (!camera || !scene || !renderer2) return
      const bound = renderer2.domElement.getBoundingClientRect()
      const clientX =
        ((_b =
          (_a = event == null ? void 0 : event.changedTouches) == null
            ? void 0
            : _a[0]) == null
          ? void 0
          : _b.clientX) ?? event.clientX
      const clientY =
        ((_d =
          (_c = event == null ? void 0 : event.changedTouches) == null
            ? void 0
            : _c[0]) == null
          ? void 0
          : _d.clientY) ?? event.clientY
      mouse.x =
        ((clientX - bound.left) / renderer2.domElement.clientWidth) * 2 - 1
      mouse.y =
        -((clientY - bound.top) / renderer2.domElement.clientHeight) * 2 + 1
  ...
  function initReSize(camera, renderer, render) {
